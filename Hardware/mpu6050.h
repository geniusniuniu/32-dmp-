...
short MPU_Get_Temperature(void); //�õ��¶�ֵ(������100��)
u8 MPU_Get_Gyroscope(short *gx,short *gy,short *gz); //�õ�������ֵ(ԭʼֵ)��Ҫ����DMP����
u8 MPU_Get_Accelerometer(short *ax,short *ay,short *az); //�õ����ٶ�ֵ(ԭʼֵ)����Ҫ����DMP����
